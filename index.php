...
while($data = mysqli_fetch_array($ambilsemuadatapesanan)){
    ...
    $hitungjumlah = mysqli_query($conn, 
    "SELECT * FROM detailpesanan WHERE idpesanan='$idp'");
...
<div class="modal-body">
    ...
    while($pelanggan = mysqli_fetch_array($getpelanggan)){
...
<div class="modal-footer">
    <button type="submit" class="btn btn-success" name="tambahpesanan">
        Submit
    </button>
