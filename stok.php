                                   ...
                                   while($data = mysqli_fetch_array($ambilsemuadataproduk)){
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            data-bs-target="#tambahstok<?= $idproduk; ?>">
                                            Tambah Stok
                                            </button>
                                        </td>
                                    </tr>
                                    <!-- Modal Tambah Stok -->
<div class="modal fade" id="tambahstok<?= $idproduk; ?>">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <input type="number" name="stok_tambah" class="form-control" placeholder="Tambah stok">
        <input type="hidden" name="idproduk" value="<?= $idproduk; ?>">
      </div>

      <div class="modal-footer">
        <button type="submit" name="tambahstok" class="btn btn-success">
        Tambah
        </button>
        </button>
      </div>
...
<div class="modal-body">
    ...
    <input type="number" name="harga" class="form-control mb-2" placeholder="Harga produk">
</div>

<div class="modal-footer">
    <button type="submit" class="btn btn-success" name="tambahproduk">
        Submit
    </button>
